<section id="home">
  ...
  <section class="sec aboutus " id="services">
    <div class="container services row">
      <div class="col-lg-4" >
        <a href="<?= base_url('admin/hasilanalisis') ?>" style="text-decoration: none; color: black;">
      ...
      <div class="col-lg-4" >
        <a href="<?= base_url('kursil/index2')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
    ...
    <div class="col-lg-4" >
      ...
      <div class="col-lg-4" >
        <a href="<?= base_url('sdm') ?>" style="text-decoration: none; color: black;">
        <div class="box mx-auto">
          <div class="iconBx text-center">
