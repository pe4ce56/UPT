<section id="home">
  ...
  <section class="sec aboutus " id="services">
    <div class="container services row">
      <div class="col-lg-4" >
        <a href="<?= base_url('home/hasilanalisis') ?>" style="text-decoration: none; color: black;">
      ...
      <div class="col-lg-4" >
        <a href="<?= base_url('kursil')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
      ...
      <div class="col-lg-4" >
        <a href="<?=base_url('pelatihan')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
    ...
    <div class="col-lg-4" >
      <a href="<?=base_url('peserta')?>" style="text-decoration: none; color: black;">
        <div class="box mx-auto">
          <div class="iconBx text-center">
    ...
    <div class="col-lg-4" >
      <a href="<?=base_url('sertifikat')?>" style="text-decoration: none; color: black;">
        <div class="box mx-auto">
          <div class="iconBx text-center">
      ...
      <div class="col-lg-4" >
        <a href="<?= base_url('home/datasdm') ?>" style="text-decoration: none; color: black;">
        <div class="box mx-auto">
          <div class="iconBx text-center">
