...
<body class="hold-transition layout-top-nav">
            ...
            <div class="card-body" style="background-color:#ededf0">
              ...
              <div class="row">
                ...
                <div class="col-4 mt-2">
                  <button type="button" class="btn btn-warning btn-edit" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-judul="<?= $row['judul']; ?>" data-pdf="<?= $row['data_pdf']; ?>" data-tgl="<?= $row['tgl']; ?>">Ubah</button>
  ...
  <div class="container mt-3">
    ...
    <!-- Modal Tambah Data-->
    <form action="<?= base_url('analisisdata/save') ?>" method="post">
            ...
            <div class="modal-body">
              <div class="container">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="name" placeholder="JUDUL" name="judul" autofocus>
                ...
                <div class="form-group">
                  ...
                  <div class="custom-file">
                    <input type="file" class="custom-file-input <?= ($validation->hasError('data_pdf')) ? 'is-invalid' : ''; ?>" id="data_pdf" name="data_pdf">
                    <div id="validationServer03Feedback" class="invalid-feedback">
