        ...
        <tbody>
          ...
          <?php foreach ($data as $row) : ?>
            <tr>
              ...
              <td>
                <a class="btn btn-warning" style="margin-bottom: 8px;" href="img_inhouse/<?= $row["gambar"] ?>" data-lightbox="mygallery">
                  <i class="fa fa-eye"></i>
                </a>&nbsp;
                <a class="btn btn-info" href="" Download="img_inhouse/<?= $row["gambar"] ?>">
