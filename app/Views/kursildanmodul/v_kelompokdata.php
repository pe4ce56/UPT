      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <?php
              $query= $this->db->distinct()->select('JUDUL_KURSIL_MODUL')->get_where('kursil_modul', array('NO' =>$NO));
              return $query;
                ...
                ?>
                  <li class="list-group-item">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" class="form-check-input product_check" value="<?= $row['JUDUL_KURSIL_MODUL']; ?>" id="jeniskursil"><?= $row['JUDUL_KURSIL_MODUL']; ?>
                      </label>
                    </div>
                  </li>
                <?php } ?>
