...
$id = $_GET['id'];
$q  = mysqli_query($conn, "SELECT * FROM diagram_coba  WHERE tahun = {$id}") or die(mysqli_error($conn));
$posts = mysqli_query($conn, "SELECT * FROM diagram_coba order by tahun DESC;;");
  ...
  <div class="card mx-auto mt-5" style="width: 60rem;">
    <div class="row border-dark">
      <div class="col-8" style="background: #ededf0">
        <a href="img_diagram/<?php echo $post['jabatan'] ?>" data-lightbox="mygallery"><img class="card-img-top mt-2" src="img_diagram/<?php echo $post['jabatan'] ?>"  style="max-height:600px;"></a>
        <div class="">
          <a href="img_diagram/<?php echo $post['jangkauan'] ?>" data-lightbox="mygallery"><img class="card-img-top mt-2" src="img_diagram/<?php echo $post['jangkauan'] ?>"  style="max-height:600px;"></a>
        </div>

        <div class="">
          <a href="img_diagram/<?php echo $post['jk'] ?>" data-lightbox="mygallery"><img class="card-img-top mt-2" src="img_diagram/<?php echo $post['jk'] ?>"  style="max-height:600px;"></a>
        </div>

        <div class="">
          <a href="img_diagram/<?php echo $post['kab_kota'] ?>" data-lightbox="mygallery"><img class="card-img-top mt-2" src="img_diagram/<?php echo $post['kab_kota'] ?>"  style="max-height:600px;"></a>
        </div>

        <div class="">
          <a href="img_diagram/<?php echo $post['pelatihan'] ?>" data-lightbox="mygallery"><img class="card-img-top mt-2" src="img_diagram/<?php echo $post['pelatihan'] ?>"  style="max-height:600px;"></a>
        </div>
      </div>
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <li class="dropdown-submenu dropdown-hover" ><div class="dropdown-item">
                <?php echo "<a href='grafis.php?id={$row['tahun']}'>{$row['tahun']}</a>"; ?>
              </div>
              </li>
